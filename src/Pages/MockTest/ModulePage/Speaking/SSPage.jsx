...
import { analyzeSentence, getOverallResult } from "../../../../utils/HelperFunction";
import { getWordDetails } from "../../../../redux/slices/disctionary";
const { Countdown } = Statistic;

export default function SSPage({ data, handleNextQuestion }) {
              ...
              <div>
                <div
                  className="flex flex-col justify-center sm:w-full  m-auto mt-5
                           "
                >
                  <h1 className="font-poppins  text-start  md:text-[20px] md:mt-0 sm:mt-10 font-[500]">
