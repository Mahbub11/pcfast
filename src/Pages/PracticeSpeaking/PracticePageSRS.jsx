...
import { RecordView } from "../../Components/MicContainer/RecordView";
...
export default function PracticePageSRS({ id, handleCloseModal }) {
  ...
  useEffect(() => {
    ...
    if (id) {
      const data = listSRS.filter((val) => index === val.index);
      setData(data[0]);
  ...
  const handleNext = () => {
    if (index <= --dataLength) {
      ...
      window.location.href = `/practice/srs-s/${nextIndex}`;
    }
  };
  const handlePrev = () => {
    if (index > 1) {
      ...
      {busy ? (
        ...
        <div className="h-auto w-[99%] m-auto bg-[#fffffff7] md:px-5 md:py-5">
          ...
          <div className="flex flex-col gap-5 sm:px-2">
            ...
            <div className="md:w-[85%] sm:w-full m-auto mt-2">
                    ...
                    <div className="m-auto flex flex-col gap-5 justify-between  h-full ">
                      ...
                      <div className="flex justify-end w-full mt-5 ml-[-10px]">
                        <div className="flex gap-2">
                          <div className="mt-2">
                            {/* <RecordView  onRecordingComplete={handleRecordingComplete}></RecordView> */}
                            <ReactMic
                              className="rounded-sm h-[1.5rem]"
                              record={record}
                              mimeType="audio/webm"
