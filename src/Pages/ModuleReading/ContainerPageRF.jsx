...
export default function ContainerPageRF() {
  ...
  const [tableData, setTableData] = useState(listRF);
  const [filterData, setFilterData] = useState(listRF);
    ...
    <div className="relative">
      <div>
        ...
        <div className=" h-[20rem] w-full mt-10">
          <ListData
            list={filterData.length === 0 ? listRF : filterData}
