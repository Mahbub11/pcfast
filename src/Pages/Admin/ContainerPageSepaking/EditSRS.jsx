...
import { SaveSpeaking, UpdatSpeaking } from "../../../redux/adminslice/Speaking";
...
export default function EditSRS() {
        ...
        <div className="w-[70%] border-2 px-5 py-5 h-auto m-auto mt-10">
          <div className="h-auto flex flex-col gap-3">
            <Input
              ...
              disabled
              value={`${data.index} Read then Speak`}
            />
              ...
              <div>
                ...
                <div className="mt-5">
                  ...
                  <div className="flex gap-3">
                   <div>
                   <Input value={questionBreakdown} onChange={(e) => setQuestionBreakdown(e.target.value)}></Input>
                    <span className="text-red-500">{customNotification}</span>
                   </div>
                    <Button className="bg-blue-300  ml-2" onClick={handleQBSave}>
                  ...
                  <List
                size="small"
                header={<div className="text-center font-[500]">Question Brakdown List</div>}
                bordered
