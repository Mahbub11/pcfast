...
import { SaveRHA2Input, SaveRHA2Result } from "../../redux/slices/readingInput";
...
export default function PracticePageRHA2({ data, meaning = true }) {
  ...
  const { inputRHA2 } = useSelector((state) => state.readingInput);
  const { resultRHA } = useSelector((state) => state.readingInput);
  const [selectVal, setSelectVal] = useState(inputRHA2);
  ...
  const handleMobileInput = (e) => {
    ...
    dispatch(SaveRHA2Result(statData));

    dispatch(SaveRHA2Input(e.replace(/\.$/, "")));
  };
  ...
  const handleMouseUp = () => {
    ...
    dispatch(SaveRHA2Input(data1.join(" ").replace(/\.$/, "")));
  };
                    ...
                    <div>
                      ...
                      >
                        ...
                        <div className="sm:mt-10 md:mt-4 sm:w-[90%] md:w-[40%] m-auto ">
                          ...
                          <h1 className="px-2 sm:text-[15px] md:text-[18px] pb-4 font-montserrat font-[500] mt-10">
                            {data.qa.q}
                          </h1>
