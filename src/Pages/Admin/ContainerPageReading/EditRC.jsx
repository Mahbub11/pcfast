...
export default function EditRC() {
...
const [data,setData]= useState(state)
 ...
 const handleEdit=()=>{
  const doc={title,question, time, level, ansList, id:data.id};
        ...
        <div className="w-[70%] border-2 px-5 py-5 h-auto m-auto mt-10">
          <div className="h-auto flex flex-col gap-3">
            <Input
              ...
              disabled
              value={`${data.index} Read & Complete`}
            />
            <Input
            value={title}
            ...
            <div className="">
              ...
              <TextArea value={question} onChange={(e)=>setQuestion(e.target.value)} placeholder="Question.."></TextArea>
            </div>
            ...
            <Select
              ...
              options={options}
            />
            <p className="mt-1">{level===1 ?<p>Easy</p> : level===2 ?<p>Medium</p>  :<p>Hard</p>} </p>
            </div>
          </div>
        </div>
