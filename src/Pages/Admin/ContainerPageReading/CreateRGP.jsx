...
export default function CreateRGPT({ refetch, id }) {
  ...
  const [innerType, setInnerTypr] = useState(325);
  ...
  const handleSave = () => {
    ...
    const doc = {rid:id,title,innerType,passage:question, ansList,optionList };
